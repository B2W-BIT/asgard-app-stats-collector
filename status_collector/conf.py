...
STATS_COLLECTOR_MESOS_MASTER_IP = os.getenv("STATS_COLLECTOR_MESOS_MASTER_IP")
...
STATS_COLLECTOR_INCLUDE_RAW_METRICS = bool(
    int(os.getenv("STATS_COLLECTOR_INCLUDE_RAW_METRICS", "0"))
)
STATS_CONNECT_TIMEOUT = int(os.getenv("STATS_CONNECT_TIMEOUT", 2))
STATS_REQUEST_TIMEOUT = int(os.getenv("STATS_REQUEST_TIMEOUT", 5))
